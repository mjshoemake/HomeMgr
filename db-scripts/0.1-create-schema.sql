...
UPDATE `mshoemake`.`users` SET `username`='mjshoemake', `password`='tAP5Xr5BAAD+jsJWz4on' WHERE `user_pk`='1';
UPDATE `mshoemake`.`users` SET `password`='Y7X1Egw6CfXdZtSzGCCE+Q==' WHERE `user_pk`='2';
