...
public abstract class AbstractDataManager
{
    ...
    * @throws DataLayerException
    */
   public void populatePreparedStatementValues(Object bean, PreparedStatement statement, Hashtable mapping, PropertyDescriptor[] pds) throws DataLayerException
   {
      try
      {
         ...
         for (int i = 0; i < pds.length; i++)
         {
            ...
            FieldDefinition fieldDef = (FieldDefinition)(mapping.get(fieldName));
    ...
    * @throws DataLayerException
    */
   private void setPreparedStatementParam(PreparedStatement statement, PropertyDescriptor prop, Object value, FieldDefinition fieldDef, int index) throws DataLayerException
   {
      try
      {
    ...
    * @throws DataLayerException
    */
   public String getInsertSqlForPreparedStatement(String table, String mappingFile, Class type, boolean keyAlreadyPopulated) throws DataLayerException
   {
      try
      {
         if (driver == null)
         ...
         return getInsertSqlForPreparedStatement(table, mapping, type, keyAlreadyPopulated);
      }
      catch (DataLayerException ex)
      {
         throw ex;
    ...
    */
   public String getInsertSqlForPreparedStatement(String table, Hashtable mapping, Class type, boolean keyAlreadyPopulated) throws DataLayerException
   {
      Object[] args = {};
      Object newobj = null;
      ...
      try
      {
         ...
         for (int i = 0; i < pds.length; i++)
         {
            ...
            FieldDefinition fieldDef = (FieldDefinition)(mapping.get(fieldName.toLowerCase()));

            if (fieldDef.getType().toLowerCase().equals("key") && ! keyAlreadyPopulated)
            {
               // Primary key.  Treat this differently.
    ...
    * @exception DataLayerException  Description of Exception
    */
   protected String getUpdateSqlForPreparedStatement(String table, Hashtable mapping, Class type, String whereClause) throws DataLayerException
   {
      Method method = null;
      Object[] args = {};
      Object newobj = null;
    ...
    * @throws DataLayerException
    */
   protected String getLoadSql(String table, Class type, Hashtable mapping, String whereClause) throws DataLayerException
   {
    ...
    * The driver to use to access the data.
    *
    * @return   com.accenture.core.model.AbstractDatabaseDriver
    */
    ...
    * @exception DataLayerException  Description of Exception
    */
   public Hashtable loadMapping(String mappingFile) throws DataLayerException
   {
      try
      {
         if (mappingFile == null)
    ...
    * @throws DataLayerException
    */
   protected String attributeToString(PropertyDescriptor prop, Object value, FieldDefinition fieldDef) throws DataLayerException
   {
      try
      {
         // Statement param indexes start with 1, not 0.
