...
class DBConnectionPool 
{
    ...
    public synchronized Connection getConnection() {
        ...
        perfLog.info("RETRIEVED CONNECTION.  Free: "+freeConnections.size()+"  Max: "+maxConn+"  In Use Count: "+inUseConnections.size());
        return con;
    }
    ...
    private Connection newConnection() {
        ...
        try {
            ...
            perfLog.info("CONNECTIONS:  Connection created ("+con.hashCode()+").  Free: "+freeConnections.size()+"  Max: "+maxConn+"  In Use Count: "+inUseConnections.size());
        } catch (SQLException e) {
   ...
   public void freeConnection(Connection con) 
   {
      ...
      {
         DBConnectionPool pool = (DBConnectionPool)e.nextElement();
         if (pool != null) 
         {
