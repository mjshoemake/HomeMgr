...
public class DataManager extends AbstractDataManager
{
    ...
    */
   public PaginatedList loadList(String sql, Class type, String mappingFile, int pageSize, int maxRecords) throws DataLayerException
   {
      Statement stmt = null;
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error loading data using SQL statement.  The open() method was never called.  DataManager="+this.hashCode());
         ...
         PaginatedList list = new PaginatedList(type, pageSize, maxRecords);
    ...
    * @throws DataLayerException
    */
   public PaginatedList loadList(String table, Class type, String mappingFile, String whereClause, int pageSize, int maxRecords) throws DataLayerException
   {
      Statement stmt = null;
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error loading data from the table "+table+".  The open() method was never called.  DataManager="+this.hashCode());
   ...
   public ResultSet executeSQL(String sql) throws DataLayerException
   {
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error loading data using SQL.  The open() method was never called.  DataManager="+this.hashCode());
         ...
         if (logPerf.isDebugEnabled())
         {
            ...
            logPerf.debug("ResultSet returned.  duration: "+duration);
         }
         return result;
      }
      catch (DataLayerException e)
   ...
   public int countRows(String table, String whereClause) throws DataLayerException
   {
      ...
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error counting rows from the table "+table+".  The open() method was never called.  DataManager="+this.hashCode());
   ...
   public void delete(String table, String whereClause) throws DataLayerException
   {
      ...
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error deleting data from the table "+table+".  The open() method was never called.  DataManager="+this.hashCode());
   ...
   public String insertBean(String table, String mappingFile, Object bean, boolean keyIncrementedDuringInsert) throws DataLayerException
   {
      try
      {
         // Method should not call open(), as this will be called already
         // before this method is called.
         return insertBeanUsingPreparedStatement(table, mappingFile, bean, keyIncrementedDuringInsert);
         //return insertBeanUsingSQL(table, mappingFile, bean, keyIncrementedDuringInsert);
      }
      catch (DataLayerException e)
      {
         throw e;
   ...
   private String insertBeanUsingSQL(String table, String mappingFile, Object bean, boolean keyIncrementedDuringInsert) throws DataLayerException
   {
      ...
      try
      {
         ...
         if (getConnection() == null)
            throw new DataLayerException("Error inserting data into the table "+table+".  The open() method was never called.  DataManager="+this.hashCode());
    ...
    * @throws DataLayerException
    */
   private String insertBeanUsingPreparedStatement(String table, String mappingFile, Object bean, boolean keyIncrementedDuringInsert) throws DataLayerException
   {
      String insertSQL = null;
      String primaryKeyValue = null;
      ...
      try
      {
         ...
         // Create prepared statement.
         insertSQL = getInsertSqlForPreparedStatement(table, mapping, bean.getClass(), ! keyIncrementedDuringInsert);
         log.info("InsertBean SQL: "+insertSQL);
   ...
   protected String getPrimaryKeyForInsertStatement(String table, Hashtable mapping, Object bean, PropertyDescriptor[] pds) throws DataLayerException
   {
      ...
      {
         // Find the key field.
         Enumeration en = mapping.elements();
         int keyCount = 0;
         FieldDefinition keyField = null;
         while (en.hasMoreElements())
         {
            FieldDefinition field = (FieldDefinition)en.nextElement();
