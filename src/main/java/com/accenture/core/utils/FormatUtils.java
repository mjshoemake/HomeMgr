...
public class FormatUtils
{
    ...
    * @return       String
    */
   public static String formatBoolean(Boolean value, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      String format = def.getFormat();
      BigInteger maxLenObj = new BigInteger(def.getMaxlen()+"");
      int maxLen = maxLenObj.intValue();
    ...
    * @return       boolean
    */
   public static boolean isValidBoolean(String value, FieldDefinition def)
   {
      String format = def.getFormat();
      BigInteger maxLenObj = new BigInteger(def.getMaxlen()+"");
      int maxLen = maxLenObj.intValue();
    ...
    * @return       boolean
    */
   public static Boolean parseBoolean(String value, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      String format = def.getFormat();
      BigInteger maxLenObj = new BigInteger(def.getMaxlen()+"");
    ...
    * @return      String
    */
   public static String formatDate(Date date, FieldDefinition def)
   {
      String format = def.getFormat();
    ...
    */
   public static Date parseDate(String date, FieldDefinition def) throws CoreException
   {
      try
      {
         String format = def.getFormat();
    ...
    * @return      boolean
    */
   public static boolean isValidDate(String date, FieldDefinition def)
   {
      try
      {
         String format = def.getFormat();
    ...
    * @return        String
    */
   public static String formatInteger(Integer number, FieldDefinition def)
   {
    ...
    * @return        boolean
    */
   public static boolean isValidInteger(String number, FieldDefinition def)
   {
      int numDigits = 0;
      String format = def.getFormat();
    ...
    * @return        String
    */
   public static String formatLong(Long number, FieldDefinition def)
   {
      return doIntegerNumber(number.toString(), def);
   }
    ...
    * @return        boolean
    */
   public static boolean isValidLong(String number, FieldDefinition def)
   {
      int numDigits = 0;
      String format = def.getFormat();
    ...
    * @return        String
    */
   public static String formatBigDecimal(BigDecimal number, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      StringBuffer buffer = new StringBuffer();
      String format = def.getFormat();
      ...
      boolean isPercent = def.isIspercent();
    ...
    * @return        BigDecimal
    */
   public static BigDecimal parseBigDecimal(String number, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      boolean isPercent = def.isIspercent();
      StringBuffer buffer = new StringBuffer();
    ...
    * @return        boolean
    */
   public static boolean isValidBigDecimal(String number, FieldDefinition def)
   {
      int numDigits = 0;
      String format = def.getFormat();
    ...
    */
   public static String formatString(String input, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      StringBuffer buffer = new StringBuffer();
      String format = def.getFormat();
    ...
    * @return       boolean
    */
   public static boolean isValidString(String value, FieldDefinition def)
   {
      String format = def.getFormat();
      BigInteger maxLenObj = new BigInteger(def.getMaxlen()+"");
      int maxLen = maxLenObj.intValue();
    ...
    * @exception CoreException  Description of Exception
    */
   public static String parseString(String input, FieldDefinition def) throws CoreException
   {
      Logger log = Logger.getLogger("Model");
      String format = def.getFormat();
      BigInteger maxLenObj = new BigInteger(def.getMaxlen()+"");
    ...
    * @return       String
    */
   private static String doIntegerNumber(String input, FieldDefinition def)
   {
      Logger log = Logger.getLogger("Model");
      StringBuffer buffer = new StringBuffer();
      String format = def.getFormat();
