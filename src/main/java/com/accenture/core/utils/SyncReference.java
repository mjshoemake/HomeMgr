...
/**
 * This class is a singleton. It is responsible for synchronizing thread access
 * to a block of code using a common reference (value).
 * <p>
 ...
 * eliminating the need for using try-catch blocks and notifyAll() on the value
 * object as used by traditional synchronization techniques.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * <i> This class utilizes techniques described in Java Developers Journal /
...
public class SyncReference {
    ...
    /**
     * WeakHashMap responsible for containing references to the values that are
     * currently being processed. When the value no longer has a strong
    ...
    private WeakHashMap map = new WeakHashMap() {
         ...
         *            in the WeakHashMap.
         * @return Object reference to the value that is now under access
         *         control thanks to the WeakHashMap.
         * 
         */
        public final Object get(Object key) {
            ...
            Object value = ((reference == null) ? null : ((WeakReference) reference).get());
            ...
            if (value == null) {
                ...
                //log.info("SyncReference - get(): Value reference found in" + " WeakHashMap");
            }
    ...
    // ---- get ----
    /**
     * Method is responsible for returning a reference for a value specified by
     * the parameter <code>key</code> in the WeakHashMap.
     * 
     * @param key that uniquely identifies the value that is being looked up in
     *            the WeakHashMap.
