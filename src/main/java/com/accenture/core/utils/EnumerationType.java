...
import com.accenture.core.model.BusinessLogicException;
...
public abstract class EnumerationType
{
    ...
    */
   public void setValue(int value) throws BusinessLogicException
   {
      if (value < getMinimumValue() || value > getMaximumValue())
      {
         // Value out of bounds.
         throw new BusinessLogicException("Value (" + value + ") out of range (" + getMinimumValue() + "-" + getMaximumValue() + ") for " + this.getClass() + ".");
      }
      else
      {
