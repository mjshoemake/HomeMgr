...
public class PerformanceEvent extends Loggable
{
   ...
   public void endEvent()
   {
      ...
      if (startDate == null)
      {
         CoreException e = new CoreException("Error trying to calculate performance metrics.  endEvent() was called without first having called startEvent().  Event type = '"+eventType+"'");
         LogUtils.log(log, e);
      }
      else
      {
   ...
   {
      return LogUtils.longToDuration(elapsedTime);
   }
   ...
   public String getLogText()
   {
      ...
      // Section 1
      result.append(LogUtils.longToDuration(elapsedTime));
      result.append("  ");
      if (numEvents == 0)
         result.append("N/A     ");
      else
         result.append(LogUtils.longToDuration(elapsedTime / numEvents));
      result.append("  ");
      result.append(LogUtils.longToDuration(minElapsedTime));
      result.append("  ");
      result.append(LogUtils.longToDuration(maxElapsedTime));
      result.append("    ");

      // Section 2
      result.append(LogUtils.longToDuration(totalElapsedTime));
      result.append("  ");
      if (numEvents == 0)
         result.append("N/A     ");
      else
         result.append(LogUtils.longToDuration(totalElapsedTime / totalNumEvents));
      result.append("  ");
      result.append(LogUtils.longToDuration(totalMinElapsedTime));
      result.append("  ");
      result.append(LogUtils.longToDuration(totalMaxElapsedTime));
      result.append("    ");

      // Section 3
      result.append(LogUtils.longToDuration(totalElapsedSincePrevious));
      result.append("  ");
      if (numEvents == 0)
         result.append("N/A     ");
      else
         result.append(LogUtils.longToDuration(totalElapsedSincePrevious / numEvents));
      result.append("  ");
      result.append(LogUtils.longToDuration(minElapsedSincePrevious));
      result.append("  ");
      result.append(LogUtils.longToDuration(maxElapsedSincePrevious));
