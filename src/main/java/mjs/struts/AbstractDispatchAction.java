...
import mjs.common.exceptions.InvalidSessionException;
 ...
 * DispatchAction classes.  It includes a Log4J mjs, so log
...
public abstract class AbstractDispatchAction extends DispatchAction {
     ...
     * @param category
     */
    public AbstractDispatchAction(String category) {
        try {
            if (category != null)
